...
import RepoBox from '../src/components/RepoBox';
  ...
  <div id="Website">
    <Sidebar />
      ...
      pt="4%">
        ...
        <Text as="b" fontSize={[30, 30, 50, 70]} textAlign="center" w="100%" fontFamily="Lexend Deca" mb="20px">
        Repositories
        </Text>
        <Text as="i" fontSize={[25, 25, 35, 35]} textAlign="center" fontFamily="Newsreader">
          I'm working on descriptions for my GitHub projects. Click on one to learn more!
        </Text>
        <Flex maxW="80%" flexWrap="wrap" alignItems="center" justifyContent="center">
            <RepoBox text="IG-88" href='../repo/ig88'>
            <Image mt="20px" ml="70px" h="30%" src="/images/discord.webp" alt="discord"/>
            <Image mt="30px" ml="5px" h="65%" src="/images/upperIG88.png" alt="ig88"/>
            </RepoBox>
            <RepoBox/>
            <RepoBox/>
            <RepoBox text="Going to be awhile" textSize={25}/>
        </Flex>
        </VStack>
        </Box>
        <Spacer/>

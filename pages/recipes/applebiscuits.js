...
const IG = () => {
  ...
  <div id="Website">
    <Sidebar />
      <Flex bg={useColorModeValue("blue.100", "gray.900")} minHeight="150vh" w="85vw" right="0" position="absolute" className="Background" 
      pt="4%" flexDirection="column"
      backgroundImage={
        useColorModeValue(
        ...
        <Stack direction={useBreakpointValue({base: "column", md:"row"})} p="0">
          ...
          <VStack>
            <Text fontSize={[15, 15, 20, 20]} fontFamily="Newsletter">
              Apple Biscuits Recipe (coming soon)
            </Text>

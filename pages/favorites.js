        ...
        <Flex padding="3%" h="100%" w="85vw" wrap="wrap" justifyContent="center">
          <Accordion allowToggle w="100%">
            ...
            <AccordionItem mb="20px">
              ...
              <AccordionPanel>
                <Flex pb={4} justifyContent="center" w="100%" wrap="wrap">
                <FavoritesBox href="https://lottiefiles.com/popular" src="https://airbnb.io/lottie/images/logo.webp" alt="Lottie" tooltip="Lotties are animations that you can use in your project!"/>
                ...
                <FavoritesBox href="https://nextjs.org/learn/basics/create-nextjs-app?utm_source=next-site&utm_medium=nav-cta&utm_campaign=next-website" src="https://cdn.worldvectorlogo.com/logos/next-js.svg" alt="NextJS"/> 

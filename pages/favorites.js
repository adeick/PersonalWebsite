...
import BookLottie from '../components/StarLottie';
              ...
              <AccordionPanel>
                ...
                <FavoritesBox  start="technologies" src="https://airbnb.io/lottie/images/logo.webp" alt="Lottie" tooltip="Lotties are animations that you can use in your project!">
                  <VStack>
                    ...
                    <Button pl="0" as="a" href="https://lottiefiles.com/popular" target="_blank" colorScheme="teal" leftIcon={<Box w="50px" play={isHoveringStar}><BookLottie/></Box>}

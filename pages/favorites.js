...
import {
  Box, Flex, Text, Button, VStack, HStack, Stack, Spacer, Image, SlideFade, Portal, Tooltip, Kbd,
  ...
  return (
    <div id="Website">
      ...
      <Box
        ...
        w="calc(85vw + var(--scrollbar-width))"
        right="0px"
        position="absolute"
                ...
                <Flex pb={4} justifyContent="center" w="100%" wrap="wrap">
                    ...
                    <VStack>
                      ...
                      <Stack direction={["column", "row"]} spacing={["12px", "24px"]}>
                        ...
                        <Button
                          ...
                          bg={useColorModeValue("green.300", "red.700")}
                          onClick={() => {
                          ...
                          _hover={{ bg: useColorModeValue("green.400", "red.800") }}
                          _active={{ bg: useColorModeValue("green.500", "red.900"), transform: "scale(0.98)" }}
                        >
                  ...
                  <FavoritesBox hash="#marvel" start="entertainment" src="/images/marvel.jpg" alt="Marvel">
                    <VStack>
                      ...
                      <HStack>
                        <Popover direction="top" closeOnBlur>
                          {({ isOpen, onClose }) => (
                            <>
                              <PopoverTrigger>
                                ...
                                <PopoverContent>
                                  ...
                                  <PopoverBody display="flex" justifyContent="center" p="0px">
                                    <VStack w='100%' mx="0" px="0px" spacing="0px">
                                      <Flex justifyContent="center" w="100%" h="42px" _hover={{ zIndex: 1, h: "50px", transform: "scale(1.07)", rounded: "md", border: "5px solid black", bg: (stones.reality ? "red.500" : "red.200") }} bg={stones.reality ? "red.500" : "red.100"}>
                                        <HStack>
                                          <Text color="black" as={stones.reality ? "b" : null}>Reality Stone</Text>
                                          <Text fontSize={stones.reality ? 16 : 12} color={stones.reality ? "black" : "gray.600"}>{stones.reality ? "Found!" : "Not Found"}</Text>
                                        </HStack>
                                      </Flex>
                                      <Flex justifyContent="center" w="100%" h="42px" _hover={{ zIndex: 1, h: "50px", transform: "scale(1.07)", rounded: "md", border: "5px solid black", bg: (stones.space ? "blue.500" : "blue.200") }} bg={stones.space ? "blue.500" : "blue.100"}>
                                        <HStack>
                                          <Text color="black" as={stones.space ? "b" : null}>  Space Stone</Text>
                                          <Text fontSize={stones.space ? 16 : 12} color={stones.space ? "black" : "gray.600"}>{stones.space ? "Found!" : "Not Found"}</Text>
                                        </HStack>
                                      </Flex>
                                      <Flex justifyContent="center" w="100%" h="42px" _hover={{ zIndex: 1, h: "50px", transform: "scale(1.07)", rounded: "md", border: "5px solid black", bg: (stones.time ? "green.500" : "green.200") }} bg={stones.time ? "green.500" : "green.100"}>
                                        <HStack>
                                          <Text color="black" as={stones.time ? "b" : null}>   Time Stone</Text>
                                          <Text fontSize={stones.time ? 16 : 12} color={stones.time ? "black" : "gray.600"}>{stones.time ? "Found!" : "Not Found"}</Text>
                                        </HStack>
                                      </Flex>
                                      <Flex justifyContent="center" w="100%" h="42px" _hover={{ zIndex: 1, h: "50px", transform: "scale(1.07)", rounded: "md", border: "5px solid black", bg: (stones.soul ? "orange.500" : "orange.200") }} bg={stones.soul ? "orange.500" : "orange.100"}>
                                        <HStack>
                                          <Text color="black" as={stones.soul ? "b" : null}>   Soul Stone</Text>
                                          <Text fontSize={stones.soul ? 16 : 12} color={stones.soul ? "black" : "gray.600"}>{stones.soul ? "Found!" : "Not Found"}</Text>
                                        </HStack>
                                      </Flex>
                                      <Flex justifyContent="center" w="100%" h="42px" _hover={{ zIndex: 1, h: "50px", transform: "scale(1.07)", rounded: "md", border: "5px solid black", bg: (stones.mind ? "yellow.500" : "yellow.200") }} bg={stones.mind ? "yellow.500" : "yellow.100"}>
                                        <HStack>
                                          <Text color="black" as={stones.mind ? "b" : null}>   Mind Stone</Text>
                                          <Text fontSize={stones.mind ? 16 : 12} color={stones.mind ? "black" : "gray.600"}>{stones.mind ? "Found!" : "Not Found"}</Text>
                                        </HStack>
                                      </Flex>
                                      <Flex justifyContent="center" w="100%" h="42px" _hover={{ zIndex: 1, h: "50px", transform: "scale(1.07)", rounded: "md", border: "5px solid black", bg: (stones.power ? "purple.500" : "purple.200") }} bg={stones.power ? "purple.500" : "purple.100"}>
                                        <HStack>
                                          <Text color="black" as={stones.power ? "b" : null}>  Power Stone</Text>
                                          <Text fontSize={stones.power ? 16 : 12} color={stones.power ? "black" : "gray.600"}>{stones.power ? "Found!" : "Not Found"}</Text>
                                        </HStack>
                                      </Flex>
                                    </VStack>
                                  </PopoverBody>
                  ...
                  <FavoritesBox hash="#lottie" start="technologies" src="/images/lottie.webp" alt="Lottie">
                    <VStack>
                      ...
                      <Button
                        pl="0"
                        as="a"
                        href="https://lottiefiles.com/popular"
                        target="_blank"
                        colorScheme="teal"
                        leftIcon={<Box w="50px" play={isHoveringStar}><StarLottie /></Box>}
                  ...
                  <FavoritesBox hash="#unity" start="technologies" src="/images/unity.jpg" alt="Unity">
                    <VStack>
                      ...
                      <Stack direction={["column", "row"]} spacing={["12px", "24px"]}>
                        ...
                        <Button
                          colorScheme="teal"
                          isDisabled={useBreakpointValue({ base: true, md: false })}
                          onClick={() => {
                            unityModal.onOpen();
                            setTimeout(() => {
                              try {
                      ...
                      <Modal isOpen={unityModal.isOpen} onClose={unityModal.onClose} size="xl" initialFocusRef={unityRef}>
                        ...
                        <ModalContent>
                          ...
                          <ModalCloseButton />
                          <ModalBody px="0" pt="0">
                            {unityModal.isOpen ? <iframe id="rocketBoost" src="https://i.simmer.io/@Darth_Vader/rocket-boost?skin=smg" width="576px" height="360px" onLoad="this.contentWindow.focus()" ref={unityRef} /> : null}
                          </ModalBody>
                          <ModalFooter>

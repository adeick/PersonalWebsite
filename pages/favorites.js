                    ...
                    {({ isOpen, onClose }) => (
                      ...
                      <Portal>
                        <PopoverContent>
                          ...
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg:    "red.400"}}   bg="red.200"><HStack alignContent="left"><Text color="black" as="b">Reality Stone</Text><Text color="gray.700">Not Found</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg:   "blue.500"}}  bg="blue.200"><HStack alignContent="left"><Text color="black" as="b">  Space Stone</Text><Text color="gray.700">Not Found</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg:  "green.500"}} bg="green.200"><HStack alignContent="left"><Text color="black" as="b">   Time Stone</Text><Text color="gray.700">Not Found</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg: "orange.300"}}bg="orange.200"><HStack alignContent="left"><Text color="black" as="b">   Soul Stone</Text><Text color="gray.700">Not Found</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg: "yellow.300"}}bg="yellow.200"><HStack alignContent="left"><Text color="black" as="b">   Mind Stone</Text><Text color="gray.700">Not Found</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg: "purple.500"}}bg="purple.200"><HStack alignContent="left"><Text color="black" as="b">  Power Stone</Text><Text color="gray.700">Not Found</Text></HStack></Flex>
                          </VStack>
                          </PopoverBody>

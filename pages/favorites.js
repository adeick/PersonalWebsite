              ...
              <AccordionPanel>
                ...
                <FavoritesBox  start="technologies" src="https://cdn.worldvectorlogo.com/logos/next-js.svg" alt="Next">
                  <VStack>  
                    ...
                    <Drawer placement="bottom" onClose={onClose} isOpen={isOpen} size="md"//Change placement to switch between right and bottom
                    >
                      <DrawerOverlay>
                        <DrawerContent borderRadius="15px 15px 0px 0px">
                          <DrawerHeader borderBottomWidth="1px">Navigation</DrawerHeader>
                          <DrawerBody>
                            <a w="100%" href='/'>Home</a>
                            <br/>
                            <a w="100%" href='./resume'>Resume</a>
                            <br/>
                            <a w="100%" href='./favorites'>Favorites</a>
                            <br/>
                            <a w="100%" href='./comics'>Comics</a>
                            <br/>
                            <a w="100%" href='./well_it_was_worth_a_try'>In Construction</a>
                          </DrawerBody>
                        </DrawerContent>
                      </DrawerOverlay>
                    </Drawer>

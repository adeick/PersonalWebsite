...
const useFavorites = () => {
    ...
    const noOfReduxClicks = useSelector((state) => state.noOfReduxClicks);
    ...
    const incrementRedux = () =>
      dispatch({
        ...
        payload: { amount: (noOfReduxClicks + 1)},
    });
    const unlockStone = (stoneType) => 
      dispatch({
        type: 'UNLOCK_STONE',
        payload: { stone: stoneType },
    });
                    ...
                    {({ isOpen, onClose }) => (
                      ...
                      <Portal>
                        <PopoverContent>
                          ...
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg:    "red.400"}}bg={stones.reality?"red.600"   :    "red.100"}><HStack ><Text color="black" as={stones.reality?"b":null}>Reality Stone</Text><Text fontSize={stones.reality?16:12} color={stones.reality?"black":"gray.600"}>{stones.reality?"Found!":"Not Found"}</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg:   "blue.500"}}bg={stones.space  ?"blue.600"  :   "blue.100"}><HStack ><Text color="black" as={stones.space  ?"b":null}>  Space Stone</Text><Text fontSize={stones.space  ?16:12} color={stones.space  ?"black":"gray.600"}>{stones.space  ?"Found!":"Not Found"}</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg:  "green.500"}}bg={stones.time   ?"green.600" :  "green.100"}><HStack ><Text color="black" as={stones.time   ?"b":null}>   Time Stone</Text><Text fontSize={stones.time   ?16:12} color={stones.time   ?"black":"gray.600"}>{stones.time   ?"Found!":"Not Found"}</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg: "orange.300"}}bg={stones.soul   ?"orange.600": "orange.100"}><HStack ><Text color="black" as={stones.soul   ?"b":null}>   Soul Stone</Text><Text fontSize={stones.soul   ?16:12} color={stones.soul   ?"black":"gray.600"}>{stones.soul   ?"Found!":"Not Found"}</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg: "yellow.300"}}bg={stones.mind   ?"yellow.600": "yellow.100"}><HStack ><Text color="black" as={stones.mind   ?"b":null}>   Mind Stone</Text><Text fontSize={stones.mind   ?16:12} color={stones.mind   ?"black":"gray.600"}>{stones.mind   ?"Found!":"Not Found"}</Text></HStack></Flex>
                          <Flex justifyContent="center" w="100%" h="42px" _hover={{zIndex:1, h:"50px", transform:"scale(1.07)", rounded:"md", border:"5px solid black", bg: "purple.500"}}bg={stones.power  ?"purple.600": "purple.100"}><HStack ><Text color="black" as={stones.power  ?"b":null}>  Power Stone</Text><Text fontSize={stones.power  ?16:12} color={stones.power  ?"black":"gray.600"}>{stones.power  ?"Found!":"Not Found"}</Text></HStack></Flex>
                          </VStack>
                          </PopoverBody>
                  ...
                  <VStack>  
                    ...
                    <Stack direction={["column", "row"]} spacing={["12px", "24px"]}>
                      ...
                      <Button colorScheme="purple" onClick={() => {
                        if(noOfReduxClicks == 99){
                          unlockStone("power");
                          //Toast
                        }
                        incrementRedux();
                      }}>
                        Number of Times you Have Clicked this Button: {noOfReduxClicks}  
                      </Button>
                    </Stack>
                  </VStack>  
                </FavoritesBox>  

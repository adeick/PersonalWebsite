...
{/* Star Wars */}
                <FavoritesBox hash="#starwars" start="entertainment"  src="https://images.wallpapersden.com/image/download/star-wars-the-mandalorian-4k-minimalist_a21tbG2UmZqaraWkpJRnZWltrWdlaW0.jpg" alt="Star Wars">
                <VStack>
...
{/* Marvel */}
                <FavoritesBox hash="#marvel" start="entertainment"  src="https://3.bp.blogspot.com/-MZ2WEgcPcoo/WvFoyQSeLwI/AAAAAAAAF1I/8-nMb4EXoQQ6dugaq8j53SVoo_1ZX08GwCLcBGAs/s00/Thanos-With-Gauntlet-Infinity-Stones-02.jpg" alt="Marvel">
                  <VStack>
...
{/* XKCD */}
                <FavoritesBox hash="#xkcd" start="entertainment" src="https://imgs.xkcd.com/comics/substitutions.png" alt="XKCD" h={[64,64,80,80]}>
...
{/* Technologies */}
            <AccordionItem mb="20px">
              ...
              <AccordionPanel>
                <Flex pb={4} justifyContent="center" w="100%" wrap="wrap">
{/* Lottie */}
                <FavoritesBox hash="#lottie" start="technologies" src="https://airbnb.io/lottie/images/logo.webp" alt="Lottie">
                  <VStack>
...
{/* Chakra */}
                <FavoritesBox hash="#chakra" start="technologies" src="https://img.stackshare.io/service/12421/rzylUjaf_400x400.jpg" alt="Chakra">
                  <VStack>
...
{/* Next */}
                <FavoritesBox hash="#next" start="technologies" src="https://cdn.worldvectorlogo.com/logos/next-js.svg" alt="Next">
                  <VStack>  
...
{/* Formik */}
                <FavoritesBox hash="#formik" start="technologies" src="https://img.stackshare.io/service/8846/preview.png" alt="Formik">
                <VStack>  
                    <Text fontSize={["13px", "17px", "20px", "20px"]} fontFamily="Lexend Deca" my="10px" mx={["20px", "20px", "40px", "80px"]} align="left">
...
{/* Unity */}
                <FavoritesBox hash="#unity" start="technologies"  src="https://fadigeorge.files.wordpress.com/2010/02/unity_01.jpg" alt="Unity">
                  <VStack>  
...
{/* Interests */}
            <AccordionItem>
              ...
              <AccordionPanel>
                <Flex pb={4} justifyContent="center" w="100%" wrap="wrap">
                <FavoritesBox hash="#space" start="interests" href="https://www.spacex.com/human-spaceflight/" src="https://img.republicworld.com/republic-prod/stories/promolarge/xxhdpi/hcukymjitstff5zm_1590834618.jpeg?tr=w-812,h-464" alt="Outer Space"/>
                ...
                <FavoritesBox hash="#vr" start="interests" src="https://images-na.ssl-images-amazon.com/images/I/610iXon9LfL._SX342_.jpg" alt="Virtual Reality">
                  <VStack>  
                    <Text fontSize={["12px", "17px", "20px", "20px"]} fontFamily="Lexend Deca" my="10px" mx={["20px", "20px", "40px", "80px"]} align="left">
                ...
                <FavoritesBox hash="#frisbee" start="interests" href="https://ultimatefrisbeehq.com/rules-of-ultimate/" src="https://cdn.ultiworld.com/wordpress/wp-content/uploads/2018/10/Screen-Shot-2018-10-30-at-4.08.45-PM-300x269.png" alt="Ultimate Frisbee"/> 
                </Flex>
              </AccordionPanel>
            </AccordionItem>
          </Accordion>

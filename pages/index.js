        ...
        <Box px={["20px", "20px", "40px", "80px"]}>
          <VStack w="100%" h="100%" spacing="0px">
            ...
            <Text fontSize={[25, 25, 35, 35]} fontFamily="Newsreader">
              ...
              Front-End Development, and Machine Learning. Right now, I'm psyched about space. Check out
              {' '}
              <Link href='./favorites'><a><Text as="u" fontFamily="Lexend Deca" color={useColorModeValue("green.500", "green.300")}>Favorites</Text></a></Link>
              {' '}
              for more!
            </Text>
          </VStack>

...
const BlogBox = (props) => {
    ...
    if(props.children){
        ...
        content = <Text fontSize={50} pt="30px" h="100%" w="100%" textAlign="center">🚧</Text>;
    }
    ...
    return (
        ...
        >
            {content}
            <Flex position="absolute" bottom="0" w="100%" h="100px" alignItems="center" justifyContent="center"
            bg={isHovering ? useColorModeValue("blue.200","red.800") : useColorModeValue("blue.300","red.900")}
            >
            <Text fontFamily="Russo One" color="black" textAlign="center" fontSize={props.textSize ? props.textSize : 28}>
